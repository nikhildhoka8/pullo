...
$htmlContent = '<div class="rvt-alert rvt-alert--danger [ rvt-m-top-md ]" role="alert" aria-labelledby="error-alert-title" data-rvt-alert="error">' .
    '<div class="rvt-alert__title" id="error-alert-title">Incorrect submission</div>' .
